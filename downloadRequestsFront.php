	...
	<body>
		...
		<div class="jumbotron">
			<div class = "container">
				...
				<br>
					<h2 style="text-align:center;"> Download Requests </h2>
				</div>
			</div>
		</div>
				...
				<div class="col-xs-12">
						...
						<div class="form-group">
                            ...
                            <div class="table-responsive">
                                <form method="post" action="sourceApproval.php">
							<table class="table table-bordered">
                                <?php
                                    if(isset($_SESSION['downsource']))
                                    {
                                        $t = $_SESSION['downsource'];
                                ...
                                <form method="post" action="report1pdf.php">
                                    <center><input type="submit" class="btn btn-info" value="Generate PDF" name="submit"></center>
                                </form>
                            </div>
						</div>
