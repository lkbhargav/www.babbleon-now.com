			...
			<div class="row row-content">
				...
				<h3 style="text-align:center"> Request for Source Code </h3> <br>
					<form method="post" action="sourceRequest.php" name="rf">
						<div class="form-group">
							...
							<input type="text" placeholder="John" name="name" class="form-control" required/>
						</div>
						
						<div class="form-group">
							<label for="email"> Email ID</label>
							<input type="email" name="email" placeholder="johnjack@gmail.com" class="form-control" required/>
						</div>
						...
						<div class="form-group">
							...
							<input type="number" name="contactNumber" class="form-control" placeholder="2031234567" required/>
							</div>
						</div>
						...
						<div>
							...
							<textarea class="form-control" rows="5" name="reason" placeholder="I like the way it works..." required maxlength="300"></textarea>
						</div>
						<br>
				...
				<div class="col-xs-12 col-sm-4 col-sm-offset-2">
					...
					<form method="post" action="downloadApplication.php">
						<div class="form-group">
							<label for="email">Email ID </label>
							<input type="email" placeholder="johnjack@gmail.com" name="email" class="form-control" required/>
						</div>
						<br>
