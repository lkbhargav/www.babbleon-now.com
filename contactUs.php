				...
				<h3 style="text-align:center"> Contact Us </h3> <br>
					<form method="post" action="contactUsBackend.php" name="rf">
						...
						<div class="form-group">
							...
							<input type="text" name="subject" class="form-control" placeholder="Feedback" required/>
						</div>
						
						<div>
							<label for="reason"> Description </label>
							<textarea class="form-control" name="description" rows="5" placeholder="This works amazing for me.." maxlength="250" required></textarea>
						</div>
						<br>
