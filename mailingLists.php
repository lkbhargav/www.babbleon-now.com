	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="collapsenavbar">
				...
				<?php	
						...
						{ ?>
						<li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-lock"> </span> Welcome Admin, <?php echo $aname; ?> <span class="caret"></span></a>
						<ul class="dropdown-menu">
		...
		<div class="jumbotron">
			<div class = "container">
				...
				<br>
					<h2 style="text-align:center;"> Group Emails </h2>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row row-content">
				<div class="col-xs-12 col-sm-6 col-sm-offset-3">
                                ...
                                <form method="post" action="mailingProcessor.php">
                                    
                                    <div class="form-group">
                                        <label> Type of users </label>
                                        <select name="users" class="form-control">
                                            <option value="act"> Activated Users </option>
                                            <option value="notact"> Not Activated Users </o[ption>
                                    ...
                                    <center><input type="submit" class="btn btn-info" value="Send"/></center>
                                        
                                </form>
                                <p align=center id="error" class="error"></p>
                                <?php
                                    if(isset($_SESSION['bod']))
                                    {
                                        $data = $_SESSION['bod'];
                                        if($data == 1)
                                        {
                                            echo "<script> document.getElementById('error').innerHTML = 'Emails sent successfully.'; </script>";    
                                        }
                                        else
                                        {
                                            echo "<script> document.getElementById('error').innerHTML = 'Mailing list is empty.'; </script>";   
                                        }
