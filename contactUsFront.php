			...
			<div class="row row-content">
				<div class="col-xs-12">
						...
						<div class="form-group">
                            ...
                            <form method="post" action="replyPage.php">
                    ...
                    <form method="post" action="report2pdf.php">
					<center><input type="submit" value="Generate PDF" class="btn btn-info" name="submit" /></center>
                    </form>
				</div>	
			</div>
		</div>
