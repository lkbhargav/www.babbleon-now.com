		...
		<div class="container">
			<div class="row row-content">
				<div class="col-xs-12 col-sm-4 col-sm-offset-4">
					<p id="message"> </p>
					<form role="form" onsubmit="return veri()" name="rf" method="post" action="passverifi.php">
						<div class="form-group">
							<label for=""> New Password </label>
							<input name="password" class="form-control" type="password" placeholder="1234name90" />
							<p id="pwerror" class="error"> </p>
						</div>
						<div class="form-group">
							<label for=""> Re-enter New Password </label>
							<input name="verpassword" class="form-control" type="password" placeholder="1234name90" />
