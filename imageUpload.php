			...
			<div class="row row-content">
				...
				<form action="imageUploadBackend.php" method="post" enctype="multipart/form-data">
					...
					<p id="error" class="error">  </p>
                        <center><input type="submit" value="Use this Image" name="submit" class="btn btn-success"></center>
				...
				<form action="deleteExistingFile.php" method="post">
                    <center><input type="submit" value="Skip" class="btn btn-primary"></center>
				</form>
				</div>
			</div>
		</div>
