	...
	<body>
		...
		<div class="jumbotron">
			<div class = "container">
				...
				<br>
					<h2 style="text-align:center;"> Resend Activation Link </h2>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row row-content">
				<div class="col-xs-12 col-sm-4 col-sm-offset-4">
					<p id="message"> </p>
					<form role="form" name="rf" method="post" action="activationLink.php">
                        <div class="form-group">
						    <input type="email" class="form-control" placeholder="johnhere@gmail.com" name="email" required/> <br>
                            ...
                            <?php
                                if(isset($_SESSION['bod']))
                                {
                                    ...
                                    if($d == 2)
                                    {
                                        echo "<script> document.getElementById('error').innerHTML = 'Sorry the email seems to be activated or is not registered.'; </script>";
                                    }
                                }
                            unset($_SESSION['bod']);
                            ?>
