	...
	<body>
		...
		<div class="jumbotron">
			<div class = "container">
				...
				<br>
					<h2 style="text-align:center;"> Forgot Username </h2>
				</div>
			</div>
		</div>
		...
		<?php
			if(isset($_SESSION['error']))
			{
				...
				if($val == 1)
				{
					echo "<script>document.getElementById('mess').innerHTML = 'Invalid Email ID';</script>";
				}
			}
