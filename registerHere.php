		...
		<div class="container">
			<div class="row row-content">
				...
				<form name="rf" onsubmit="return verify()" role="form" method="post" action="mailAndMessage.php">
					...
					<div class="form-group">
						<label for="password"> Password: </label>
						<input type="password" name="password" placeholder="Eg: Passw0rd!" class="form-control" required />
						<p id="pwerror" class="error"> </p>
					</div>
					
					<div class="form-group">
						<label for="vpassword"> Verify Password: </label>
						<input type="password" name="verpassword" placeholder="Eg: Passw0rd!" class="form-control" required />
